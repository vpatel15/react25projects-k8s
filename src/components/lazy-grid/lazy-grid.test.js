...
test("should render list of grid items", async () => {
  render(<LazyGrid />);
  await waitFor(() => {
    const gridListItems = screen.getAllByTestId("grid-list-item");
    expect(gridListItems.length).toBe(3);
  });
});
